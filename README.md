...
git clone [https://github.com/msknh3x/](https://github.com/msknh3x/)<repo-name>.git
cd <repo-name>

# Run a script from the current focus topic
python "Variables/Basics Of variables/f_strings.py"
